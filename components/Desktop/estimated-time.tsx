...
const EstimatedTime = () => {
  ...
  useEffect(() => {
    ...
    const countdownInterval = setInterval(() => {
      const now = new Date()
      const targetDate = new Date('2024-12-30T21:30:00')
    ...
    <div className="absolute h-[204.89px] w-[416.31px] bottom-0 left-[6%] scale-50 md:scale-75 lg:scale-100">
      <div className="h-full w-full relative">
        <svg width="461" height="215" viewBox="0 0 461 215" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M162.663 58.5068H119.536V8.62857H121.437V56.6061H162.663V58.5068Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path d="M39.8996 172.88L38.5887 171.569L103.673 106.484V73.0575L119.862 56.8684L121.173 58.1792L105.574 73.844V107.271L105.312 107.533L39.8996 172.88Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path d="M31.4458 208.01H3.45898V180.023H5.35967V206.109H31.4458V208.01Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path d="M40.1631 185.005H38.2622V173.142H26.4645V171.307H40.1631V185.005Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path opacity="0.5" d="M34.0666 200.801H10.4711V177.206H34.0666V200.801Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path d="M26.3334 193.066H18.2062V185.004H26.3334V193.066Z" fill="#F8F8F8" fillOpacity="0.6"/>
          <path d="M372.074 82.1685H161.746V66.4381H163.647V80.2677H372.074V82.1685Z" fill="#F8F8F8" fillOpacity="0.6"/>
          
          {/* Animated element */}
          <circle cx="230" cy="107" r="5" fill="#F8F8F8" fillOpacity="0.6" transform={`rotate(${rotation} 230 107)`}>
            <animateTransform
        ...
        <Image
          ...
          width={461}
          height={215}
          className="absolute top-24 left-32 h-12 w-auto z-0"
        />
      </div>
    </div>
  )
